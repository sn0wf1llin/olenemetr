...
def generate_squared_type():
    return '''{}{}{}{}
              {}{} {}'''.format(
        random.choice(setts.DIGITS),
        random.choice(setts.DIGITS),
        random.choice(setts.DIGITS),
        random.choice(setts.DIGITS),
        random.choice(setts.LETTERS),
        random.choice(setts.LETTERS),
        random.choice(setts.DIGITS))


def generate_rectangle_type():
    return "{}{}{}{} {}{} {}".format(
        random.choice(setts.DIGITS),
        random.choice(setts.DIGITS),
        random.choice(setts.DIGITS),
...
def generate_code():
    # just for training use 1 type, after success train and test use 2 types
    return generate_rectangle_type()
    # choice = random.randint(0, 1)
    # if choice == 0:
    #     return generate_rectangle_type()
    # else:
    #     return generate_squared_type()
...
def generate_bg(num_bg_images):
    ...
    while not found:
        ...
        fname = "bgs/{0}.jpeg".format(random.randint(0, num_bg_images - 1))
...
if __name__ == "__main__":
    ...
    im_gen = itertools.islice(generate_ims(), GEN_COUNT)
